...
from vllm.entrypoints.openai.video_reatime.connection import RealtimeVideoConnection
from vllm.entrypoints.openai.video_reatime.serving import OpenAIServingRealtimeVideo
...
async def realtime_endpoint(websocket: WebSocket):
    ...
    if serving is None:
        ...
        await websocket.send_text('{"type": "error", "message": "Realtime video not enabled", "code": "not_available"}')
